...
public class SysDepartmentController extends Authenticator {
    ...
    @Log(level = EnumLogLevel.DEBUG, module = "系统设置", context = "添加部门信息")
    @PostMapping
    ...
    @Log(level = EnumLogLevel.WARN, module = "系统设置", context = "删除部门信息")
    @DeleteMapping("/{id}")
    ...
    @Log(level = EnumLogLevel.INFO, module = "系统设置", context = " 修改部门信息")
    @PutMapping("/{id}")
    ...
    @Log(level = EnumLogLevel.TRACE, module = "系统设置", context = "查询部门单条信息")
    @GetMapping("/{id}")
    ...
    @Log(level = EnumLogLevel.TRACE, module = "系统设置", context = "查询部门列表信息树成功")
    @GetMapping
