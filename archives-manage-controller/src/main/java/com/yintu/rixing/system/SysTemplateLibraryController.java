...
public class SysTemplateLibraryController extends AuthenticationController {
    ...
    @Log(level = EnumLogLevel.DEBUG, module = "系统管理", description = "查询模板库单条信息")
    @GetMapping("/{id}")
    ...
    public Map<String, Object> findById(@PathVariable Integer id) {
        ...
        return ResponseDataUtil.ok("查询模板库单条信息成功", sysTemplateLibrary);
    }
    ...
    public Map<String, Object> findTree() {
        ...
        return ResponseDataUtil.ok("查询档案库列表信息树成功", treeNodeUtils);
    }
