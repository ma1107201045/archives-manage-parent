...
public class SysPermissionController extends Authenticator {
    ...
    @Log(level = EnumLogLevel.DEBUG, module = "系统管理", description = "添加权限信息")
    @PostMapping
    ...
    @Log(level = EnumLogLevel.TRACE, module = "系统管理", description = "删除权限信息")
    @DeleteMapping("/{id}")
    ...
    @Log(level = EnumLogLevel.INFO, module = "系统管理", description = " 修改权限信息")
    @PutMapping("/{id}")
    ...
    @Log(level = EnumLogLevel.TRACE, module = "系统管理", description = "查询权限单条信息")
    @GetMapping("/{id}")
    ...
    @Log(level = EnumLogLevel.TRACE, module = "系统管理", description = "查询权限列表信息树")
    @GetMapping
