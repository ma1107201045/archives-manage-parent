...
public class ArchArchivesQuantityStatisticsController {
    ...
    public ResultDataUtil<List<ArchArchivesQuantityStatisticsQueryVo>> findArchivesName() {
        List<ArchArchivesQuantityStatisticsQueryVo> archQuantityStatisticsQueryVos = iArchQuantityStatisticsService.findArchivesName();
        return ResultDataUtil.ok("查询档案数量统计-名称成功", archQuantityStatisticsQueryVos);
    }
    ...
    public ResultDataUtil<ArchArchivesQuantityStatisticsDataVo> findArchivesName(@Validated ArchCommonQueryDto archQuantityStatisticsQueryDto) {
        ArchArchivesQuantityStatisticsDataVo archQuantityStatisticsQueryVo = iArchQuantityStatisticsService.findArchivesData(archQuantityStatisticsQueryDto);
        return ResultDataUtil.ok("查询档案数量统计-数据成功", archQuantityStatisticsQueryVo);
    }
