...
public interface InxDataStatisticsMapper {
     ...
     * @param formalLibrary4 是否正式库 1：是 2：否
     * @param formalLibrary5 是否正式库 1：是 2：否
     * @return ..
     */
    List<Long> selectInxDataStatistics(Short userType, Short formalLibrary, List<String> tableNames, Short status, Short formalLibrary4, Short formalLibrary5);
