...
public enum EnumArchivesLibraryDefaultField {
    ...
    TOPIC_NAME("题名", 4, "topic_name", ""),
    RETENTION_PERIOD("保管期限", 4, "retention_period", ""),
    SECURITY_LEVEL("密级", 4, "security_level", ""),
    FILING_ANNUAL("归档年度", 4, "filing_annual", ""),
    DEPARTMENT_ID("组织机构", 4, "department_id", ""),
